...
6. Sistema gera o ingresso (código curto e sorteado → QR Code); o ingresso permanece vinculado ao cliente.
7. Cliente vê e compartilha o ingresso.
8. Antes ou no dia do evento, a portaria entra com o usuário `GATE` do evento e valida o ingresso associado (válido / inválido / já utilizado / evento errado).
