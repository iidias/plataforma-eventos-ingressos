...
// evento e o status — nada sobre quem comprou e, principalmente, nada do código
// que a portaria valida. Quem recebe o link confere o ingresso; quem entra é o
// titular. Token inexistente responde 404 e cai na tela de erro daqui.
      ...
      <div className="max-w-[560px] mx-auto px-6 py-8 flex flex-col gap-6">
        ...
        {status === 'ready' && (
          <>
            <Alert
              type="info"
              message="Visualização somente leitura. Este link mostra a situação do ingresso; o código de entrada fica apenas com o titular, que é quem o apresenta na portaria."
            />
